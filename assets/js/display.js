...
display.innerHTML = `
    <div class="flex items-end mb-2 w-1/6 cursor-pointer absolute bottom-4" style="flex-grow: 1">
        ...
        <div id="history" class="border-2 cursor-auto overflow-auto border-gray-line bg-black-gray-100 min-w-[240px] min-h-[80px] max-h-[200px] top-10 hidden absolute rounded-[8px] py-2 px-4 z-50">
